...
const Content = () => {
    ...
    return (
        <section className='mt-5 lg:-mt-20 md:mb-20'>
            <div className="w-full flex flex-row-reverse justify-center md:mt-48">
                <div className='w-full md:w-[40%] flex flex-col gap-1 lg:gap-10 lg:ml-10'>
                    ...
                    <div className="bg-[#002157] -ml-2 w-[120px] flex rounded-md py-2 sm:w-[300px] lg:w-[480px] mx-auto mt-2 hover:bg-[#286cdb]">
